...
import {FaSync, FaSignInAlt} from 'react-icons/all'
import {APP_URL, APP_SECURITY_AUTHENTICATE_LOGIN_URL, APP_SECURITY_AUTHENTICATE_LOGIN_FORGOTPASSWORD_URL, APP_ERROR_404_URL} from '../../../../url/AppUrl'
...
const LogIn = () => {
    ...
    const submitAction = () => {
        setSuccess({message: `You have successfully logged in.`})
        setTimeout(() => {
